...
import {
  ...
  CalendarDays, ClipboardList, Star,
...
export default function CoordinatorDashboard() {
  ...
  const coordinatorLinks = [
    ...
    { label: 'Setup Deskriptor', desc: 'Atur kriteria per mapel', icon: ClipboardList, href: '/master/deskriptor' },
    { label: 'Grade Boundaries', desc: 'Atur batas nilai MYP', icon: BarChart3, href: '/master/grade-boundaries' },
    { label: 'Progres Nilai', desc: 'Pantau progres input nilai', icon: TrendingUp, href: '/laporan/progres-nilai' },
    { label: 'Cetak Rapor', desc: 'Preview dan cetak rapor', icon: FileText, href: '/laporan/rapor' },
  ];
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className={`text-sm font-medium text-primary-200 transition-opacity duration-300 ${!schoolProfile.name ? 'opacity-0' : 'opacity-100'}`}>IB MYP Coordinator</span>
              </div>
